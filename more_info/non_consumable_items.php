      ...
      <div class="content-wrapper container">
        ...
        <?php
            ...
            if (isset($_GET['search']) && !empty($_GET['search'])) {
                $search = $_GET['search'];
                $query = "SELECT * FROM `inventory` WHERE `item-type`= 'non-consumable' AND `inventory-list` LIKE '%$search%'
                          ORDER BY `inventory-list` $order 
                          LIMIT $itemsPerPage OFFSET $offset";
            } else {
                $query = "SELECT * FROM `inventory` WHERE `item-type`= 'non-consumable'
            ...
            $countQuery = "SELECT COUNT(*) AS total FROM `inventory` WHERE `item-type` = 'non-consumable'";
            if (isset($_GET['search']) && !empty($_GET['search'])) {
