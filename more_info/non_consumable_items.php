               ...
               <tbody>
                  <?php
                     ...
                     if (isset($_GET['search']) && !empty($_GET['search'])) {
                         $search = $_GET['search'];
                         $query = "SELECT * FROM `inventory` WHERE `item-type` = 'non-consumable' AND `inventory-list` LIKE '%$search%' ORDER BY `inventory-list` $order";
                     } else {
                         $query = "SELECT * FROM `inventory` WHERE `item-type` = 'non-consumable'  ORDER BY `inventory-list` $order";
                     }
