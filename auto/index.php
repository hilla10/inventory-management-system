        ...
        <div class="container">
            <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNav">
                <ul class="navbar-nav mx-auto ">
                    <li class="nav-item">
                        <a tabindex=\"0\" class="nav-link link-light link-opacity-50-hover" href="#" data-bs-toggle="modal"
                ...
                <div class="d-flex">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <div class="dropdown nav-item">
                                <button tabindex="0" class="btn btn-info dropdown-toggle me-5 mb-1" type="button"
...
<?php  $title = "Auto Department"; // Set the default title
        ...
        <div class="container content-wrapper">
              <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">auto Department</li>
                    </ol>
                    </section>
            ...
            $countQuery = "SELECT COUNT(*) AS total FROM `inventory` WHERE `department` = 'AUTO'";
            if (isset($_GET['search']) && !empty($_GET['search'])) {
